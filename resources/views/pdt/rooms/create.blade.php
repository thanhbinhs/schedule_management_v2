    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('pdt.rooms.store') }}" method="POST">
            ...
            <div class="form-group mb-3">
                <label for="RoomID" class="form-label"><i class="fas fa-key me-1"></i> Room ID</label>
                <input type="text" id="RoomID" name="RoomID" class="form-control" placeholder="Nhập Room ID" required>
            </div>
            <div class="form-group mb-3">
                <label for="scale" class="form-label"><i class="fas fa-user-friends me-1"></i> Sức Chứa</label>
                <input type="number" id="scale" name="scale" class="form-control" placeholder="Nhập sức chứa" required>
            </div>
            <div class="mt-3">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus-circle me-2"></i> Lưu</button>
                <a href="{{ route('pdt.rooms.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i> Trở về</a>
            </div>
        </form>
    </div>
@endsection