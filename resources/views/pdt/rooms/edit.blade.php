...
@section('content')
    <div class="container">
        <h2 class="text-center mb-4">Sửa Phòng</h2>
        <form action="{{ route('pdt.rooms.update', $room) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="RoomID" name="RoomID" class="form-control" value="{{ $room->RoomID }}" readonly>
            </div>
            <div class="form-group mb-3">
                <label for="scale" class="form-label"><i class="fas fa-user-friends me-1"></i> Sức Chứa</label>
                <input type="number" id="scale" name="scale" class="form-control" value="{{ $room->scale }}" required>
            </div>
            <div class="mt-3">
