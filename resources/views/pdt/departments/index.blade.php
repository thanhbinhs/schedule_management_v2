...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-end mb-3">
        <a href="{{ route('pdt.departments.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle me-2"></i> Thêm Khoa Mới</a>
    </div>
    ...
    @if($departments->isEmpty())
        <p class="text-muted text-center"><i class="far fa-folder-open me-1"></i> Không có khoa nào được thêm vào.</p>
    @else
                    ...
                    @foreach($departments as $department)
                        <tr>
                            ...
                            <td data-label="Trưởng khoa">
                                ...
                                @else
                                    <span class="text-muted"><i class="fas fa-user-tie-slash me-1"></i> Chưa có Trưởng khoa</span>
                                @endif
                            </td>
                            <td data-label="Hành Động" class="action-buttons text-center">
                                <a href="{{ route('pdt.departments.edit', $department->DepartmentID) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit me-1"></i> Sửa</a>
                                <form action="{{ route('pdt.departments.destroy', $department->DepartmentID) }}" method="POST" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa khoa này?');">
                                    @csrf
                                    @method('DELETE')
