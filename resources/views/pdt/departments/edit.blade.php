...
<div class="container mt-4">
    <h2 class="text-center mb-4">Sửa Thông Tin Khoa</h2>

    @if ($errors->any())
        <div class="alert alert-danger">
            <strong><i class="fas fa-exclamation-triangle me-2"></i> Đã xảy ra lỗi!</strong> Vui lòng kiểm tra lại thông tin nhập vào.<br><br>
            <ul>
    ...
    <form action="{{ route('pdt.departments.update', $department->DepartmentID) }}" method="POST">
        ...
        <div class="form-group mb-3">
            <label for="DepartmentName" class="form-label"><i class="fas fa-building-columns me-1"></i> Tên Khoa:</label>
            <input type="text" id="DepartmentName" name="DepartmentName" class="form-control" value="{{ old('DepartmentName', $department->DepartmentName) }}" required />
        </div>

        <div class="form-group mb-3">
            <label for="DepartmentAddress" class="form-label"><i class="fas fa-map-marker-alt me-1"></i> Địa Chỉ:</label>
            <input type="text" id="DepartmentAddress" name="DepartmentAddress" class="form-control" value="{{ old('DepartmentAddress', $department->DepartmentAddress) }}" required />
        </div>

        <div class="form-group mb-3">
            <label for="LeaderDepartmentID" class="form-label"><i class="fas fa-user-tie me-1"></i> Trưởng khoa:</label>
            <select id="LeaderDepartmentID" name="LeaderDepartmentID" class="form-control">
                <option value="" disabled>-- Chọn Trưởng khoa (tùy chọn) --</option>
                <option value="">-- Không chọn Trưởng khoa --</option>
            ...
            <small class="text-muted"><i class="fas fa-info-circle me-1"></i> Giá trị này là tùy chọn và phải là một Giảng viên đã tồn tại.</small>
        </div>

        <div class="mt-3">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i> Cập Nhật Khoa</button>
