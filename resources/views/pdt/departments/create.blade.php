...
<div class="container mt-4">
    <h2 class="text-center mb-4">Thêm Khoa Mới</h2>
    ...
    <form action="{{ route('pdt.departments.store') }}" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" id="DepartmentName" name="DepartmentName" class="form-control" placeholder="Nhập tên khoa" value="{{ old('DepartmentName') }}" required />
        </div>

        <div class="form-group mb-3">
            <label for="DepartmentAddress" class="form-label"><i class="fas fa-map-marker-alt me-1"></i> Địa Chỉ:</label>
            <input type="text" id="DepartmentAddress" name="DepartmentAddress" class="form-control" placeholder="Nhập địa chỉ khoa" value="{{ old('DepartmentAddress') }}" required />
        </div>

        <div class="mt-3">
            <button type="submit" class="btn btn-primary"><i class="fas fa-plus-circle me-2"></i> Thêm Khoa</button>
