...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0 text-center">Thông tin môn học</h2>
        <a href="{{ route('department.subjects.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle me-2"></i> Thêm mới</a>
    </div>

    @if($subjects->isEmpty())
        <div class="alert alert-info"><i class="fas fa-info-circle me-2"></i> Không tìm thấy môn học</div>
    @else
                    ...
                    @foreach($subjects as $subject)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('department.subjects.edit', $subject->SubjectID) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit me-1"></i> Sửa</a>
