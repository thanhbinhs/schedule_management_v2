...
<body>
    <!-- Navigation Bar -->
    <nav class="navbar navbar-expand-lg navbar-light"> {{-- Changed navbar-dark bg-dark to navbar-light --}}
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('department.professors.index') }}"><i class="fas fa-university me-2"></i> Xin chào {{$departmentName}}</a> {{-- Added icon --}}
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('department.professors.index') }}"><i class="fas fa-chalkboard-teacher me-1"></i> Giảng viên</a> {{-- Added icon --}}
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('department.majors.index') }}"><i class="fas fa-graduation-cap me-1"></i> Ngành học</a> {{-- Added icon --}}
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('department.education_programs.index') }}"><i class="fas fa-book-reader me-1"></i> Chương trình đào tạo</a> {{-- Added icon --}}
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('department.subjects.index') }}"><i class="fas fa-book me-1"></i> Môn học</a> {{-- Added icon --}}
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('department.schedules.index') }}"><i class="far fa-calendar-alt me-1"></i> Thời khóa biểu</a> {{-- Added icon --}}
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <a class="btn btn-outline-primary" href="{{ route('logout') }}"  {{-- Changed btn-outline-light to btn-outline-primary --}}
                           onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <i class="fas fa-sign-out-alt me-2"></i> Đăng xuất {{-- Added icon --}}
                        </a>
                    </li>
                </ul>
            </div>
